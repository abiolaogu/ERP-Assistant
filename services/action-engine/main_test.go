...
func createAction(t *testing.T, mux http.Handler, tenant string, payload map[string]any) map[string]any {
	t.Helper()
...
func TestCursorRoundTrip(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		createAction(t, mux, tenant, map[string]any{
...
func TestTenantIsolation(t *testing.T) {
	...
	createAction(t, mux, "tenant-A", map[string]any{"name": "A Action", "action_type": "api_call"})
	createAction(t, mux, "tenant-B", map[string]any{"name": "B Action", "action_type": "api_call"})
...
func TestUpdateAndDelete(t *testing.T) {
	...
	resp := createAction(t, mux, "t1", map[string]any{"name": "Del Test", "action_type": "custom"})
