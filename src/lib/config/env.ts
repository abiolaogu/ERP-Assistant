export const env = {
  ...
  module: process.env.NEXT_PUBLIC_MODULE ?? "assistant",
  ...
  authPolicy: process.env.NEXT_PUBLIC_AUTH_POLICY ?? "iam-only",
  ...
  dbaasDefaultProject: process.env.NEXT_PUBLIC_DBAAS_PROJECT ?? "assistant-core",
  dbaasMockMode:
