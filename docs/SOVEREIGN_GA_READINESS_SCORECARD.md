# ERP-Assistant - Sovereign GA Readiness Scorecard
...
- Benchmark set: Microsoft Copilot, Notion AI, Slack AI
- Category-king hypothesis: Provide a trustworthy, context-rich assistant that can act across the full ERP estate.
...
| p95 latency (critical journey) | <= 250ms | Pending production telemetry | Platform |
