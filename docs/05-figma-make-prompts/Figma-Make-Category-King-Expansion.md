# Assistant Figma Make Category-King Expansion

## Purpose

This prompt system pushes ERP-Assistant beyond baseline UX into category-king territory by tightly connecting Product strategy, System constraints, and engineering delivery.
...
```text
You are designing ERP-Assistant, a multi-tenant enterprise Product. Build a coherent UX system for User and Admin personas across web and responsive states.
...
```text
From the BRD and PRD, produce 6 critical journeys for ERP-Assistant:
- onboarding
...
```text
Generate a component and token system for ERP-Assistant:
