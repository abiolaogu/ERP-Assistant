  ...
  return (
    <div className="flex h-screen overflow-hidden">
      <Sidebar className="hidden border-r border-[var(--border)] md:flex">
        <SidebarHeader className="p-4 text-base font-semibold">ERP-Assistant</SidebarHeader>
        <SidebarContent>
          <NavItems />
        </SidebarContent>
      </Sidebar>
        ...
        <header className="flex h-16 items-center gap-3 border-b border-[var(--border)] bg-white px-4">
          <Sheet>
            ...
            <SheetContent side="left">
              <div className="mb-4 border-b border-[var(--border)] pb-3 text-base font-semibold">ERP-Assistant</div>
